...
- @sec-fastq-in-depth
- The previouse course's [fasta introduction](https://pmoris.github.io/FiMAB-bioinformatics/content/unix/5-unix-files-and-dirs.html#sec-fasta)
...
- @sec-fastq-in-depth
- The previous course's [section on fastq](https://pmoris.github.io/FiMAB-bioinformatics/content/unix/5-unix-files-and-dirs.html#sec-fastq)
...
- The previous course's [section on sam](https://pmoris.github.io/FiMAB-bioinformatics/content/unix/6-unix-more-commands.html#sec-sam-format)
- The previous course's [section on bam](https://pmoris.github.io/FiMAB-bioinformatics/content/unix/6-unix-more-commands.html#sec-bam-format)
- @sec-alignment
...
- The previous course's [section on vcf](https://pmoris.github.io/FiMAB-bioinformatics/content/unix/7-unix-redirection.html#sec-vcf)
- @sec-variant-calling
